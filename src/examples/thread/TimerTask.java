...
/**
 * This class implements the same API as the Java 1.3 java.util.TimerTask. Note
 * that a TimerTask can only be scheduled on one Timer at a time, but that this
...
public abstract class TimerTask implements Runnable {
	...
	/**
	 * When it the timer scheduled to execute? The run() method can use this to see
