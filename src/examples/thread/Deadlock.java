...
/**
 * This is a demonstration of how NOT to write multi-threaded programs. It is a
 * program that purposely causes deadlock between two threads that are both
 * trying to acquire locks for the same two resources. To avoid this sort of
 * deadlock when locking multiple resources, all threads should always acquire
